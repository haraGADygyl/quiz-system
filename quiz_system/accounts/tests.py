...
class StudentSignUpViewTest(TestCase):
    ...
    def test_is_student(self):
        ...
        self.response = self.client.post(reverse('student_signup'),
                                         {'username': self.user.username, 'password1': 'password123456',
                                          'password2': 'password123456'}, follow=True)
        print("|||||||||||||||||||||||||||||||||||||||||||||")
        print(self.response)
...
class TeacherSignUpViewTest(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.user = create_custom_user(username="teacher1", is_teacher=True, password="password123456")
        # cls.stud1 = create_student(user=cls.user)
    ...
    def test_is_teacher(self):
        # self.client.login(username=self.user.username, password='password123456')
        # self.client.force_login(self.user)
        self.response = self.client.post(reverse('teacher_signup'),
                                         {'username': self.user.username, 'password1': 'password123456',
                                          'password2': 'password123456'}, follow=True)
        print("|||||||||||||||||||||||||||||||||||||||||||||")
        print(self.response)
