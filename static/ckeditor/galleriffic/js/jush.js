    ...
    highlight_states: function (states, text, in_php, escape) {
        ...
        var tr = { // transitions
            ...
            cnf: {
                quo: /"/,
                one: /#/,
                cnf_php: /(\b)(PHPIniDir)([ \t]+)/i,
                cnf_phpini: /(\b)(php_value|php_flag|php_admin_value|php_admin_flag)([ \t]+)/i
            },
            cnf_php: {1: /()/},
